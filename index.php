...
<body>
    ...
    <header>
        ...
        <navbar class="navbar">
            <a class="nodecoration" href="#">Início</a>
            <a class="nodecoration" href="#cases">Trabalhos</a>
            <a class="nodecoration" href="#">Formação</a>
            <a class="nodecoration" href="#">Contato</a>
        </navbar>
    </header>
    ...
    <main>
        <section class="apresentation white-pane">
            ...
            <br>
            <br>
            <p>Sou um profissional da área da tecnologia voltado para o do desenvolvimento de sistemas. </p>
            <br>
